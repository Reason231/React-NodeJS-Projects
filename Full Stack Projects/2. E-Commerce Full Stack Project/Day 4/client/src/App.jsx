...
function App() {
  ...
  // auth-middleware
  const {isAuthenticated,user,isLoading} = useSelector(state => state.auth) // Automatically updates redux state of "store folder" on change
  const dispatch=useDispatch()  // Triggers store-folder reducer to update the state
