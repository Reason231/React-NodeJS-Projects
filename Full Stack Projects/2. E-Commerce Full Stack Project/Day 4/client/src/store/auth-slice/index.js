...
export const registerUser = createAsyncThunk(
  ...
  async (formData) => {
    ...
    const response = await axios.post(
      ...
      formData, 
      { withCredentials: true }  // ells the browser to include cookies (or other credentials like auth headers)
    );
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(registerUser.fulfilled, (state, action) => {
        ...
        state.user = null;  // the user has to be loggedIn to set the userName info
