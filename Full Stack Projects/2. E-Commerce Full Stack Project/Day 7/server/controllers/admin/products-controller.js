...
const handleImageUpload= async(req,res) =>{
    try{
        const b64=Buffer.from(req.file.buffer).toString("base64")  // Converts the binary image into a Base64-encoded string.
        const url = "data:" + req.file.mimetype + ";base64," + b64 // Wraps the base64 string in a Data URI format.
        const result = await imageUploadUtil(url);  // Uploads the Data URI to Cloudinary using the API.
